...
class Navigator:
    ...
    def __init__(self, main_controller):
        ...
        self._factory = None  # Will be set by MainWindowController after construction
        self.view = main_controller.view
        self.active_cycle = None

    def set_factory(self, factory):
        """Sets the ViewControllerFactory after initialization to break circular dependency."""
    ...
    def _set_current_main_widget(self, widget: QWidget):
        ...
        """
        onboarding_controller = self._factory.get_active_onboarding_controller() if self._factory else None
    ...
    def handle_navigation(self, nav_data: dict):
        ...
        if self._factory and self._factory.is_onboarding_active() and not isinstance(
    ...
    def show_performance_graphs(self):
        ...
        view = self._factory.create_performance_graphs()
    ...
    def show_session_choice(self, recommended: dict, alternatives: list):
        ...
        view = self._factory.create_session_choice(recommended, alternatives)
        self._set_current_main_widget(view)
    ...
    def show_session_mode_choice(self, initial_session_data: dict):
        ...
        view = self._factory.create_session_mode_choice(initial_session_data)
        self._set_current_main_widget(view)
    ...
    def show_cycle_editor(self, exam_id: int, cycle_id: int | None):
        ...
        view = self._factory.create_cycle_editor(exam_id, cycle_id)
        self._set_current_main_widget(view)
    ...
    def show_onboarding(self):
        ...
        if onboarding_controller:
            ...
            view, controller = self._factory.create_onboarding()
            self._set_current_main_widget(view)
    ...
    def show_subject_summary(self):
        ...
        if not self._main_ctl.plan_manager.get_cached_plan():
            ...
            return
        view = self._factory.create_subject_summary()
        self._set_current_main_widget(view)

    def show_history(self):
        log.debug("Navigator creating and showing History view.")
        view = self._factory.create_history()
        self._set_current_main_widget(view)
