...
class SqliteCycleSubjectService(BaseService, ICycleSubjectService):
    ...
    def get_subjects_for_cycle(self, cycle_id: int) -> List[CycleSubject]:
        ...
        for row in rows:
            ...
            cycle_subjects.append(CycleSubject(
                id=row_dict['id'],
                cycle_id=row_dict['cycle_id'],
                subject_id=row_dict['subject_id'],
                relevance_weight=row_dict['relevance_weight'],
                volume_weight=row_dict['volume_weight'],
                difficulty_weight=row_dict['difficulty_weight'],
                is_active=row_dict['is_active'],
                final_weight_calc=row_dict['final_weight_calc'],
                num_blocks_in_cycle=row_dict['num_blocks_in_cycle'],
                name=row_dict['name'],
                color=row_dict['color'],
                date_added=row_dict['date_added'],
                current_strategic_state=row_dict['current_strategic_state'],
                state_hysteresis_data=row_dict['state_hysteresis_data'],
